            ...
            <div class="card-body">
                <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input name="name" type="text" value="<?php echo $editAdmin['name']; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name product">
                    ...
                    <div class="form-group">
                        ...
                        <input name="email" type="email" value="<?php echo $editAdmin['email']; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="enter email...">
                    ...
                    <div class="form-group">
                        ...
                        <input name="phone" type="number" value="<?php echo $editAdmin['phone']; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="+84 *********">
